...
export const metadata: Metadata = {
  ...
  description:
    "Questões, caderno de erros, revisões automáticas, cronograma personalizado e mentoria para concursos policiais.",
  openGraph: {
...
// Atualização de publicação após reconexão com a Vercel.
